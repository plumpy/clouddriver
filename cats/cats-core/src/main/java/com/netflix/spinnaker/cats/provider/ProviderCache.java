...
public interface ProviderCache extends Cache {
   ...
   * @param agentDataTypes Authoritative cache results define graph vertices, informative results
   *     create edges.
   * @param cacheResult The definitive set of results from source.
   */
  void putCacheResult(String source, CachingAgentDataTypes agentDataTypes, CacheResult cacheResult);
   ...
   */
  void addCacheResult(String source, CachingAgentDataTypes agentDataTypes, CacheResult cacheResult);
